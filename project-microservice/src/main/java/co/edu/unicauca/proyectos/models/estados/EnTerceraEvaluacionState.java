...
public class EnTerceraEvaluacionState implements EstadoProyecto {
    ...
    public void evaluar(ProyectoGrado p, boolean aprobado, String obs) {
        ...
        if (aprobado) {
            ...
            p.incrementarIntentoORechazarDefinitivo();     //→ Rechazado definitivo
        }
    }
    @Override public void reintentar(ProyectoGrado p) {
        throw new IllegalStateException("No hay más reintentos. Use nueva propuesta solo si reglas lo permiten.");
    }
